import{j as e}from"./jsx-runtime-kP7yjuVC.js";import{e as c,B as I,F as M,t as R,T as $}from"./Text-DL3_Xpov.js";import"./index-BmYOpbA5.js";import"./index-C92LrVYg.js";import"./index-xq08HDZe.js";const{useArgs:K}=__STORYBOOK_MODULE_PREVIEW_API__,G={title:"Beta/Tooltip",component:c,argTypes:{size:{defaultValue:{summary:"medium"}},delayDuration:{defaultValue:{summary:500}},disableCloseOnOutside:{defaultValue:{summary:!1}}},args:{trigger:e.jsx(I,{children:"Hover over me"}),children:"This is a tooltip text."},parameters:{layout:"centered"},tags:["autodocs"]},r={},s={args:{delayDuration:1e3}},n={name:"Preferred side",args:{side:"right",open:!0},render:l=>e.jsx(c,{...l,children:`This is a ${l.side} tooltip text.`})},o={args:{size:"small",open:!0}},a={args:{size:"medium",open:!0}},t={args:{size:"large",open:!0}},i={args:{open:!0,trigger:e.jsx($,{children:"Tooltip trigger is over here"})},render:function(d){const{open:u,onOpenChange:p,...V}=d,[,L]=K(),m=g=>{p==null||p(g),L({open:g})};return e.jsxs(M,{gap:R.space.small,alignItems:"center",children:[e.jsx(I,{onClick:()=>m(!u),children:"Toggle tooltip manually"}),e.jsx(c,{...V,onOpenChange:m,open:u,disableCloseOnOutside:!0,children:d.children})]})}};var h,x,T;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:"{}",...(T=(x=r.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var O,f,C;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    delayDuration: 1000
  }
...
}`,...(F=(v=i.parameters)==null?void 0:v.docs)==null?void 0:F.source}}};const J=["Default","DelayDuration","PreferredSide","Small","Medium","Large","Controlled"];export{i as Controlled,r as Default,s as DelayDuration,t as Large,a as Medium,n as PreferredSide,o as Small,J as __namedExportsOrder,G as default};
