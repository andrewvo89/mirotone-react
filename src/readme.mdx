...
<table>
  ...
  <tbody>
    <tr>
      <td>Color</td>
      <td>`tokens.color`</td>
      <td>[Color docs](/docs/tokens-colors--docs)</td>
    </tr>
    <tr>
      <td>Typography</td>
      <td>`tokens.typography`</td>
      <td>[Typography docs](/docs/tokens-typography--docs)</td>
    </tr>
    <tr>
      <td>Spacing</td>
      <td>`tokens.space`</td>
      <td>[Spacing docs](/docs/tokens-spacing--docs)</td>
    </tr>
    <tr>
      <td>Border radius</td>
      <td>`tokens.borderRadius`</td>
      <td>[Border radius docs](/docs/tokens-border-radius--docs)</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Dropdown </td>
      <td>Beta</td>
      <td>[Docs](/docs/beta-dropdown--docs)</td>
    </tr>
    <tr>
      <td>Tooltip</td>
      <td>Planned</td>
